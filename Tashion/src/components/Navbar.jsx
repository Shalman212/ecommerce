...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            <img src={assets.logo} style={{ width: '80px' }} alt="" />
            <ul className='hidden laptop:flex gap-5 text-sm text-gray-700'>
                ...
                <NavLink to='/collection' className='flex flex-col items-center gap-1 text-gray-700 no-underline'>
                    <p>COLLECTION</p>
                    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden' />
                </NavLink>
                <NavLink to='/about' className='flex flex-col items-center gap-1 text-gray-700 no-underline'>
                    <p>ABOUT</p>
                    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden' />
                </NavLink>
                <NavLink to='/contact' className='flex flex-col items-center gap-1 text-gray-700 no-underline'>
                    <p>CONTACT</p>
                    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden' />
                </NavLink>
            ...
            <div className='flex items-center gap-6'>
                <img src={assets.search_icon} className='w-5 cursor-pointer hover:scale-110 transition-transform duration-200' alt="" />
